...
public:
    ...
    void setupUi(QWidget *Formkaryawan)
    {
        ...
        formGroupBox_2->setGeometry(QRect(40, 20, 321, 121));
        ...
        pushButton_2->setGeometry(QRect(150, 150, 61, 31));
        pushButton_3 = new QPushButton(Formkaryawan);
        pushButton_3->setObjectName("pushButton_3");
        pushButton_3->setGeometry(QRect(220, 150, 61, 31));
        pushButton_4 = new QPushButton(Formkaryawan);
        pushButton_4->setObjectName("pushButton_4");
        pushButton_4->setGeometry(QRect(290, 150, 61, 31));
        tableKaryawan = new QTableView(Formkaryawan);
        tableKaryawan->setObjectName("tableKaryawan");
        tableKaryawan->setGeometry(QRect(40, 190, 661, 161));
    ...
    void retranslateUi(QWidget *Formkaryawan)
    {
        ...
        gajiTotalLabel->setText(QCoreApplication::translate("Formkaryawan", "Bayar Total", nullptr));
        nIKLabel->setText(QCoreApplication::translate("Formkaryawan", "ID", nullptr));
