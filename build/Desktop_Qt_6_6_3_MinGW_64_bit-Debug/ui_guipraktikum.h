...
public:
    ...
    void setupUi(QMainWindow *guiPraktikum)
    {
        ...
        guiPraktikum->resize(758, 283);
        centralwidget = new QWidget(guiPraktikum);
        centralwidget->setObjectName("centralwidget");
        pushButton = new QPushButton(centralwidget);
        pushButton->setObjectName("pushButton");
        pushButton->setGeometry(QRect(270, 70, 231, 81));
    ...
    void retranslateUi(QMainWindow *guiPraktikum)
    {
        ...
        pushButton->setText(QCoreApplication::translate("guiPraktikum", "Form Pelanggan", nullptr));
    } // retranslateUi
